...
starts = [
    ...
    datetime(2024,10,21,15,40),
    datetime(2024,10,21,15,50),
...
DESTINATION_PHONE_NUMBER = 'whatsapp:+553199795243' #whatsapp:+553199795243
...
for i in range(len(rows)):
    ...
    subdag_task = SubDagOperator(
        ...
        subdag=send_message_subdag('psg_10', f'conversation_{i}', starts[i], schedulerss[i], row),
        dag=dag_one
    )
